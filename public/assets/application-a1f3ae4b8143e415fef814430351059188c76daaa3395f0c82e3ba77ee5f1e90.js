...
(function() {
  $(document).ready(function() {
    $("#log-activities-button").click(function() {
      var index, weekId;
      $('.activity-row').each(function() {
        var $tableRow, activityDate, activityDescription, activityDuration, activityId;
        $tableRow = $(this);
        ...
        if (activityDate !== "" && activityDuration !== "" && activityDescription !== "") {
          return $.ajax("/update_activity", {
            type: 'PUT',
            data: {
              id: activityId,
              date: activityDate,
      ...
      $.ajax('/bank', {
        ...
        success: function(data) {
          return $("#not-complete-" + weekId).html(data);
        }
      });
      $.ajax('/calendar', {
        type: 'GET',
      ...
      $.ajax('/progress', {
        ...
        success: function(data) {
          return $("#progress-" + weekId).html(data);
        }
      });
    ...
    return $('#myModal').on('shown.bs.modal', function() {
      ...
      return $(".activity-check:checked").each(function() {
        return $.ajax('/activity_tr', {
          type: 'GET',
          data: {
            id: $(this).data().activityId
          },
          success: function(data) {
            return $activitiesHolder.append(data);
          }
        });
      });
    });
